...
function num = match(image1,des1_out,loc1_out, image2,des2_out,loc2_out)
...
% % % % %     end
% % % % 
% % % % matchedPoints1 = puntosMatch(:,2:-1:1);
% % % % matchedPoints2 =  puntosMatch(:,4:-1:3);
% % % % 
% % % % showMatchedFeatures(im1,im2,matchedPoints1,matchedPoints2,'montage');pause();
% % % % 
% % % % 
% % % % 
% % % %     hold off;
...
%     
%     
% function dibujar_filtrado(im1,im2,puntos1,puntos2)
% 
% 
%     im3=im1;
% 
...
%     cols1 = size(im1,2);
%     for i = 1: size(des1,1)
%             line([puntos1(i,1) puntos2(i,1)], ...
%                 [puntos1(i,2) puntos2(i,2)], 'Color', 'c');
%         end
%     
%     hold off;
% 
